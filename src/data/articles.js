export const articles = [
  {
    ...
    excerpt: '本文详细介绍 Vue 3 的 Composition API，包括 setup、ref、reactive 等核心概念...',
...
Composition API 提供了更灵活的代码组织方式，特别适合处理复杂的组件逻辑。`,
  ...
  },
  {
    ...
    excerpt: '深入探讨 TypeScript 的高级类型系统，包括泛型、条件类型、映射类型等...',
...
\`\`\``,
  ...
  },
  {
    ...
    excerpt: '从基础到高级，全面掌握 CSS Grid 布局技术...',
...
对于大文件处理，使用 Stream 可以节省内存。`,
  ...
  },
  {
    id: 5,
    title: 'Git 工作流最佳实践',
    excerpt: '介绍团队协作中常用的 Git 工作流，包括 Git Flow、GitHub Flow 等...',
    content: `# Git 工作流最佳实践
...
GitHub Flow 更加简化，适合持续部署。`,
  ...
  },
  {
    ...
    excerpt: '从零开始学习 Docker，掌握容器化部署的核心技能...',
